...
/**
 * Modern logger with colored output for Vortex
 */
export class Logger
{
    ...
    private static readonly STYLES = {
        ...
        // Components
        vortex: 'color: #E91E63; font-weight: bold',
    ...
    static get instance(): Logger
    {
        if(!this._instance)
        {
            this._instance = new Logger('Vortex');
        }
    ...
    private static readonly LOG_LEVEL_STORAGE_KEY = 'vortex:logLevel';
    private static readonly LOG_LEVEL_STORAGE_PREFIX = 'vortex:logLevel:';
	 ...
	 *
	 *   localStorage.setItem('vortex:logLevel:RoomEngine', 'DEBUG')   // one logger
	 *   localStorage.setItem('vortex:logLevel', 'INFO')               // global override
	 *
    ...
    private getSourceStyle(): string
    {
        ...
        if(name.includes('vortex')) return Logger.STYLES.vortex;
