...
import {PostThreadMessageParser} from '@habbo/communication/messages/parser/groupforums/PostThreadMessageParser';

/**
 * AS3: sources/win63_version/habbo/communication/messages/incoming/groupforums/PostThreadMessageEvent.as
