...
export interface ICaption {
    // AS3: sources/win63_version/habbo/window/utils/AlertDialogCaption.as::get text()
    text: string;
    // AS3: sources/win63_version/habbo/window/utils/AlertDialogCaption.as::get toolTip()
    toolTip: string;
    // AS3: sources/win63_version/habbo/window/utils/AlertDialogCaption.as::get visible()
    visible: boolean;
}
...
export class AlertDialogCaption implements ICaption 
{
    ...
    // AS3: sources/win63_version/habbo/window/utils/AlertDialogCaption.as::_text
    ...
    // AS3: sources/win63_version/habbo/window/utils/AlertDialogCaption.as::set text()
    ...
    // AS3: sources/win63_version/habbo/window/utils/AlertDialogCaption.as::set toolTip()
    ...
    // AS3: sources/win63_version/habbo/window/utils/AlertDialogCaption.as::set visible()
