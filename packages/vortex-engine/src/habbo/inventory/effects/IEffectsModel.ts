...
export const EffectFilter = {
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/inventory/effects/EffectsModel.as::FILTER_NONE
    ALL: -1,
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/inventory/effects/EffectsModel.as::FILTER_INCLUDE_INACTIVE
    INACTIVE: 0,
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/inventory/effects/EffectsModel.as::FILTER_INCLUDE_ACTIVE
    ACTIVE: 1,
} as const;
