...
export class CatalogWidgetToggleEvent
{
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/catalog/viewer/widgets/events/CatalogWidgetToggleEvent.as::get widgetId()
    get widgetId(): string
    {
        return this._widgetId;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/catalog/viewer/widgets/events/CatalogWidgetToggleEvent.as::get enabled()
    get enabled(): boolean
    {
