...
export class ClubSpecialInfoBubbleView 
{
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/catalog/clubcenter/ClubSpecialInfoBubbleView.as::_window
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/catalog/clubcenter/ClubSpecialInfoBubbleView.as::dispose()
    dispose(): void 
    {
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/catalog/clubcenter/ClubSpecialInfoBubbleView.as::onTimerEvent()
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/catalog/clubcenter/ClubSpecialInfoBubbleView.as::positionWindow()
    ...
    // reach this handler.
    private onDesktopDown(_event: WindowEvent): void
    {
        this._manager?.removeBreakdown();
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/catalog/clubcenter/ClubSpecialInfoBubbleView.as::setElementText()
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/catalog/clubcenter/ClubSpecialInfoBubbleView.as::getLocalization()
