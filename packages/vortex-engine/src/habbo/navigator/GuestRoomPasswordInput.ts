...
{
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/GuestRoomPasswordInput.as::_navigator
    private _navigator: IHabboTransitionalNavigator | null;
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/GuestRoomPasswordInput.as::_window
	 ...
	 */
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/GuestRoomPasswordInput.as::show()
	 ...
	 */
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/GuestRoomPasswordInput.as::showRetry()
    showRetry(): void
    {
        if(this._roomData)
        {
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/GuestRoomPasswordInput.as::dispose()
    dispose(): void
    {
        if(this._window)
        {
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/GuestRoomPasswordInput.as::createWindow()
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/GuestRoomPasswordInput.as::setInfoText()
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/GuestRoomPasswordInput.as::hide()
    private hide(): void
    {
        if(!this._window) return;
