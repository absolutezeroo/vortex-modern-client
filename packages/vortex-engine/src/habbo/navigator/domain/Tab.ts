...
export class Tab
{
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::_navigator
    private _navigator: ITabNavigator;
    private _id: number;
    private _defaultSearchType: number;
    private _tabPageDecorator: ITabPageDecorator;
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::_searchMsg
    private _searchMsg: number;
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::_selected
    private _selected: boolean = false;
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::_button
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::sendSearchRequest()
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::get id()
    get id(): number
    {
        return this._id;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::get defaultSearchType()
    get defaultSearchType(): number
    {
        return this._defaultSearchType;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::get selected()
    get selected(): boolean
    {
        return this._selected;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::set selected()
    set selected(value: boolean)
    {
        this._selected = value;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::get tabPageDecorator()
    get tabPageDecorator(): ITabPageDecorator
    {
        return this._tabPageDecorator;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::get searchMsg()
    get searchMsg(): number
    {
        return this._searchMsg;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::get button()
    get button(): ITabButtonWindow | null
    {
        return this._button;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/navigator/domain/Tab.as::set button()
