...
export class CutToWidth implements IBinarySearchTest
{
    ...
    // AS3: sources/win63_version/habbo/navigator/CutToWidth.as::_text
    private _text: ITextWindow | null = null;
    // AS3: sources/win63_version/habbo/navigator/CutToWidth.as::_maxWidth
    private _maxWidth: number = 0;

    // AS3: sources/win63_version/habbo/navigator/CutToWidth.as::test()
    ...
    // AS3: sources/win63_version/habbo/navigator/CutToWidth.as::beforeSearch()
