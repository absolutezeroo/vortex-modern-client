...
export class BackgroundObjectType
{
    ...
    // DEVIATION: the same file also declares CLASS_LINEAR, CLASS_SPIRAL, CLASS_STATIC_ANIMATED and
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/backgroundobjects/_SafeCls_4477.as::CLASS_RANDOM_WALK
}
