 ...
 *
 * @see sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/backgroundobjects/StaticAnimatedBackgroundObject.as
 */
export class StaticAnimatedBackgroundObject extends BackgroundObject
{
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/backgroundobjects/StaticAnimatedBackgroundObject.as::StaticAnimatedBackgroundObject()
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/backgroundobjects/StaticAnimatedBackgroundObject.as::dispose()
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/backgroundobjects/StaticAnimatedBackgroundObject.as::update()
    override update(elapsedTime: number): void
    {
        ...
        else
        {
            ...
            // by total animation duration - see sources/WIN63-202607011411-782849652's
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/backgroundobjects/StaticAnimatedBackgroundObject.as::onPathResetEvent()
