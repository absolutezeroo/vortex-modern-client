 ...
 *
 * @see sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as
 */
export class CommonWidgetSettings
{
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as::TEXTCOLOR_DEFAULT
    private static readonly TEXTCOLOR_DEFAULT: number = 0xFF000000;
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as::ETCHINGCOLOR_DEFAULT
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as::CommonWidgetSettings()
    ...
    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as::get isTextColorSet()
    get isTextColorSet(): boolean
    {
        return this._textColor !== CommonWidgetSettings.TEXTCOLOR_DEFAULT;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as::get isEtchingColorSet()
    get isEtchingColorSet(): boolean
    {
        return this._etchingColor !== CommonWidgetSettings.ETCHINGCOLOR_DEFAULT;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as::get isEtchingPositionSet()
    get isEtchingPositionSet(): boolean
    {
        return this._etchingPosition !== CommonWidgetSettings.ETCHINGPOSITION_DEFAULT;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as::get textColor()
    get textColor(): number
    {
        return this._textColor;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as::get etchingColor()
    get etchingColor(): number
    {
        return this._etchingColor;
    }

    // AS3: sources/WIN63-202607011411-782849652/src/com/sulake/habbo/friendbar/landingview/layout/CommonWidgetSettings.as::get etchingPosition()
