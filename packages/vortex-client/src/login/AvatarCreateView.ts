 ...
 * (Vortex.bootstrap() completes before the login flow is shown, see
 * VortexApp.init()), so the full figuredata/palette set is available here.
 *
...
export class AvatarCreateView implements IAvatarImageListener
{
	 ...
	 * during Vortex.bootstrap() — well before the login flow even shows). isReady
