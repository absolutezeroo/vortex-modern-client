 ...
 * and flash_version's `MarketPlaceOfferState` - not decompiler corruption.
 * flash_version has the real name and the first constant's real name
 ...
 * (real class name recovered from sources/flash_version/src/com/sulake/habbo/catalog/marketplace/MarketPlaceOfferState.as)
 */
