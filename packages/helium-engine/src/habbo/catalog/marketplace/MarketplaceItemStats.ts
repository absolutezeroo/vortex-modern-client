 ...
 * present in flash_version's `MarketplaceItemStats` (whose readable field
 ...
 * (real class name recovered from sources/flash_version/src/com/sulake/habbo/catalog/marketplace/MarketplaceItemStats.as)
 */
export class MarketplaceItemStats
{
    ...
    // (real field name recovered from flash_version: `_currentOfferCount`)
